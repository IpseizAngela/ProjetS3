...
void ranking (SDL_Surface *screen, SDL_Surface *background, int score_player) 
{
  ...
  if (file != NULL) {
    ...
    print_text(first, sc_f, screen, 0, SCREEN_HEIGHT - 105, 32);
    print_text(second, sc_s, screen, 0, SCREEN_HEIGHT - 70, 32);
    print_text(third, sc_t, screen, 0, SCREEN_HEIGHT - 35, 32);
