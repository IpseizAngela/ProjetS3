...
void ranking (SDL_Surface *screen, SDL_Surface *background, int score_player, int win) 
{
  ...
  print_name (screen, background, name, win);
   ...
   tab_number[2] = "3 :";
    ...
    tab_number[8] = "9 :";
    tab_number[9] = "10 :";*/
    /*sprintf (tab_number[0], "%s", "1 :");
    sprintf (tab_number[1], "%s", "2 :");
    sprintf (tab_number[2], "%s", "3 :");
    sprintf (tab_number[3], "%s", "4 :");
    sprintf (tab_number[4], "%s", "5 :");
    sprintf (tab_number[5], "%s", "6 :");
    sprintf (tab_number[6], "%s", "7 :");
    sprintf (tab_number[7], "%s", "8:");
    sprintf (tab_number[8], "%s", "9 :");
    sprintf (tab_number[9], "%s", "10 :");*/
  ...
  if (file != NULL) {
    ...
    for (i = 0; i < NB_RANK; i++) {
        printf ("tab_score [%d] = %s \n", i, tab_score[i] );
    }
    for (i = 0; i < NB_RANK; i++) {
        printf ("int_score [%d] = %d \n", i, int_score[i] );
    }
    for (i = 0; i < NB_RANK; i++) {
        printf ("tab_colors [%d] = %d \n", i, tab_colors[i] );
    }
    ...
    if (nb_in_rank < 0) {
        print_text(name, -1, screen, x1,  y + mult * 10, size, 3);
        print_text("", score_player, screen, x2,  y + mult * 10, size, 3);
    }
...
/*const char fill_tab_rank () {
    const char  tab [NB_RANK];
    sprintf (tab[0], "%s", "1 :");
    sprintf (tab[1], "%s", "2 :");
    sprintf (tab[2], "%s", "3 :");
    sprintf (tab[3], "%s", "4 :");
