...
void ranking (SDL_Surface *screen, SDL_Surface *background, int score_player) 
{
  ...
  if (file != NULL) {
    ...
    print_text("1 : ", -1, screen, (SCREEN_WIDTH / 2) - 50, (2 * SCREEN_HEIGHT / 3) , 20);
    print_text(first, sc_f, screen, SCREEN_WIDTH / 2,  2 * SCREEN_HEIGHT / 3 , 20);
    print_text("2 : ", -1, screen, (SCREEN_WIDTH / 2) - 50,  2 * SCREEN_HEIGHT / 3 + 70, 20);
    print_text(second, sc_s, screen, SCREEN_WIDTH / 2,  2 * SCREEN_HEIGHT / 3 + 70, 20);
    print_text("3 : ", -1, screen, (SCREEN_WIDTH / 2) - 50,  2 * SCREEN_HEIGHT / 3 + 35, 20);
    print_text(third, sc_t, screen, SCREEN_WIDTH / 2,  2 * SCREEN_HEIGHT / 3 + 35, 20);
